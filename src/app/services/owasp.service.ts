...
export class OWASPService {
  ...
  getAllOWASP() {
    this.http.get('https://flashcards-23d9f.firebaseio.com/1IRp0xyNhOLlXydMalqROVvU6YmXq42nRWEDLumLvmd8/Sheet1.json'
    ).subscribe(data => {
      let owasp_data: any = this.owaspData = data as JSON;
